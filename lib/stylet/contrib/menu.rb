...
module Stylet
  module Menu
    module Core
      ...
      def close_trigger?
        root.cancel_buttons.any? {|e|root.input.button.send(e).trigger?} || Stylet::Base.active_frame.key_down?(SDL2::Key::BACKSPACE)
      end
      ...
      begin
        ...
        def current_run_trigger?
          root.select_buttons.any? {|e|root.input.button.send(e).trigger?} || Stylet::Base.active_frame.key_down?(SDL2::Key::RETURN)
        end
