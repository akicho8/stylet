...
window = SDL2::Window.create("testsprite", SDL2::Window::POS_CENTERED, SDL2::Window::POS_CENTERED, 640, 480, 0)

renderer = window.create_renderer(-1, SDL2::Renderer::Flags::ACCELERATED|SDL2::Renderer::Flags::TARGETTEXTURE)
texture = renderer.load_texture("../examples/assets/mario.png")

rect = SDL2::Rect.new(48, 128, 32, 32)
renderer.copy(texture, nil, rect)
renderer.copy_ex(texture, nil, SDL2::Rect[128, 256, 48, 48], 45, nil, SDL2::Renderer::FLIP_NONE)
